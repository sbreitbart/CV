...
**Data analysis**: Data cleaning & wrangling, high-performance computing, SLURM, parallelization, geospatial analysis
...
University of Toronto & Blood Tribe

Alberta, Canada

2023 - present

-   Collaborate with the Blood Tribe of the Kainai First Nation to co-create project assessing reservation's rangeland health
-   Creating an interactive Shiny App to guide various stakeholders through the data analysis while teaching key data science concepts
...
## Selected Workshop {data-icon="none"}
